...
Private Sub Form_Load()
 ...
 Dim i%, j%
    ...
    Label1(1).Caption = frmMainText.Text1.Font

    Grid1.Font.Name = frmMainText.Text1.Font
    Gridcount = 31
   ...
   For i = 0 To 22 ' Set row numbers.
    ...
    For j = 0 To 9 ' col numbers
     ...
     Grid1.Text = Chr$(Gridcount) 'LTrim(Str$(GridCount)) + ": " + Chr$(GridCount)
    Next j
...
Private Sub Grid1_Click()
  ...
  charnum = Asc(Char$) '(Grid1.Row * Grid1.Col) + 31
  If charnum > 126 Then
