...
Begin VB.Form frmPrintPreview 
   ...
   Begin iQNotepad.CandyButton cmdPrevPage 
      Height          =   315
      Left            =   3300
      TabIndex        =   16
      Top             =   60
      ...
      ColorScheme     =   0
   End
   Begin iQNotepad.CandyButton cmdZoomOut 
      Height          =   315
      Left            =   300
      TabIndex        =   14
      Top             =   60
   ...
   Begin VB.HScrollBar HScroll1 
      ...
      Width           =   10125
   End
   Begin iQNotepad.CandyButton cmdZoomIn 
      Height          =   315
      Left            =   1020
      TabIndex        =   15
      Top             =   60
      ...
      ColorScheme     =   0
   End
   Begin iQNotepad.CandyButton cmdNextPage 
      Height          =   315
      Left            =   4560
      TabIndex        =   17
      Top             =   60
      ...
      ColorScheme     =   0
   End
   Begin iQNotepad.CandyButton cmdClose 
      Height          =   315
      Left            =   8940
      TabIndex        =   18
      Top             =   60
   ...
   Begin iQNotepad.CandyButton cmdPrint 
      ...
      IconHighLiteColor=   0
      CaptionHighLiteColor=   0
      Picture         =   "frmPrintPreview.frx":10BE
      PictureAlignment=   2
      Checked         =   0   'False
      ColorButtonHover=   16760976
      ColorButtonUp   =   15309136
...
Sub PrintPreviewPage(inControl As Control, InPage As Integer)
   ...
   ' rectPage.Bottom = inControl.Height * Screen.TwipsPerPixelY
    ...
    PageCtn = 1
    Do
        newStartPos = SendMessage(frmMainText.txtInsert.hwnd, EM_FORMATRANGE, True, mFormatRange)
